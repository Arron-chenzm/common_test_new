...
class qesandans():
    ...
    def run(self):
        ...
        #print(state)
        btn8 = Button(600+self.weight/3, 275+self.height/3, "NEXT", surBtnNormal, surBtnMove, surBtnDown, self.btnCallBack, btnFont, (255, 0, 0))
        #print(state)
        ...
        btn7 = Button(200+self.weight/3, 150+self.height/3, "不确定", surBtnNormal, surBtnMove, surBtnDown, self.btnCallBack7, btnFont, (255, 0, 0))
